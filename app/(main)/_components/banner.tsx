...
export const Banner = ({ documentId }: BannerProps) => {
  ...
  return (
    <div className="w-full bg-rose-500 flex items-center text-white text-center text-sm justify-center p-2 space-x-2">
      <p className="uppercase">This page is archived</p>
      <Button
        variant="outline"
        size="sm"
        onClick={onRestore}
